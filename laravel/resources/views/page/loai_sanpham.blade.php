					...
					<div class="col-sm-9">
						<div class="beta-products-list">
							...
							<div class="beta-products-details">
								<p class="pull-left">Tìm kiếm {{count($loai)}} Sản phẩm</p>
								<div class="clearfix"></div>
							</div>
								...
								<div class="col-sm-4">
									<div class="single-item">
										...
										<div class="single-item-caption">
											<a class="add-to-cart pull-left" href="{{route('themgioihang',$sp->id)}}"><i class="fa fa-shopping-cart"></i></a>
							...
							<div class="row">
								...
								<div class="col-sm-4">
									<div class="single-item">
										...
										<div class="single-item-caption">
											<a class="add-to-cart pull-left" href="{{route('themgioihang',$sp_k->id)}}"><i class="fa fa-shopping-cart"></i></a>
											<a class="beta-btn primary" href="{{route('chitietsanpham',$sp_k->id)}}"> <i class="fa fa-chevron-right">Chi tiết</i></a>
											<div class="clearfix"></div>
										</div>
									</div>
								</div>
