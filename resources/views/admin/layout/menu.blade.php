                    ...
                    <ul class="nav" id="side-menu">
                        ...
                        <li>
                            ...
                            <ul class="nav nav-second-level">
                                <li>
                                    <a href="admin/sanpham/danhsach">Danh sách các sản phẩm</a>
                                </li>
								<li>
                        ...
                        <li>
                            <a href="admin/khachhang/danhsach"><i class="fa fa-cube fa-fw"></i>Khách hàng</a>
                            
                            <!-- /.nav-second-level -->
                        </li>
						<li>
                            <a href="admin/donhang/danhsach"><i class="fa fa-truck fa-fw"></i> Đơn hàng<span class="fa arrow"></span></a>
                            <ul class="nav nav-second-level">
								<li>
                                    <a href="admin/chitietdonhang/danhsach">Chi tiết đơn hàng</a>
                                </li>
                            </ul>
                            <!-- /.nav-second-level -->
                        </li>
