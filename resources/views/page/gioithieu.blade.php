...
<div class="inner-header" style="background-color: #ccccff">
	...
	<div class="container" style="background-color: #ccccff">
		<div id="content" style="background-color: #ccccff">
			<div class="our-history">
				<h2 class="text-center wow fadeInDown">Our History</h2>
				<div class="space35" style="background-color: #ccccff">&nbsp;</div>
				...
				<div class="history-slider" >
					...
					<div class="history-slides">
						<div> 
							<div class="row">
							<div class="col-sm-5">
								<img src="source/image/gioithieu/1.jpg"  alt="">
							</div>
							<div class="col-sm-7">
						...
						<div> 
							<div class="row">
							<div class="col-sm-5">
								<img src="source/image/gioithieu/2.jpg" alt="">
							</div>
							<div class="col-sm-7">
						...
						<div> 
							<div class="row">
							<div class="col-sm-5">
								<img src="source/image/gioithieu/3.jpg" alt="">
							</div>
							<div class="col-sm-7">
						...
						<div> 
							<div class="row">
							<div class="col-sm-5">
								<img src="source/image/gioithieu/4.jpg" alt="">
							</div>
							<div class="col-sm-7">
						...
						<div> 
							<div class="row">
							<div class="col-sm-5">
								<img src="source/image/gioithieu/5.jpg" alt="">
							</div>
							<div class="col-sm-7">
						...
						<div> 
							<div class="row">
							<div class="col-sm-5">
								<img src="source/image/gioithieu/6.jpg" alt="">
							</div>
							<div class="col-sm-7">
						...
						<div> 
							<div class="row">
							<div class="col-sm-5">
								<img src="source/image/gioithieu/7.jpg" alt="">
							</div>
							<div class="col-sm-7">
