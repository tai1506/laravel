...
Route::group(['prefix'=>'user'], function (){
	...
	Route::group(['prefix'=>'chitietdonhang'], function (){
		Route::get('danhsach','CTDonHangController@getDanhSach');

		Route::get('sua/{id_bill}','CTDonHangController@getSua');
		
		Route::post('sua/{id_bill}','CTDonHangController@postSua');
		
		Route::get('xoa/{id_bill}','CTDonHangController@getXoa');
